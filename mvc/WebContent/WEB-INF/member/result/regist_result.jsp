...
<body>
	<div class="box">
		...
		%>
		<h2>가입실패!!</h2>
		<a href="${context}/member/service/regist.jsp"></a>
		<%
			} else {
				member.setId(id);
				member.setPw(pw);
	  ...
	  <span class = "meta">SSN</span>  <%=request.getParameter("ssn") %><br />
		...
		<a href="${context}/index.jsp"> <img
			src="${context}/member2/img/home.png" alt="home" style="width: 30px" />
		</a> <a href="${context}/member_controller.jsp"> <img
			src="${context}/member2/img/member.png" alt="member"
			style="width: 60px" />
		</a>

...
%> 		
		...
		<tr>
			<td rowspan="3" style="width:60%">
				<img src="${context}/img/<%=member.getId()%>.jpg" alt="W3Schools.com" width="400" height="350">
			</td>
	...
	<input type="reset" value="취 소" />
		...
		<a href="${context}/member/member_controller.jsp">
			<img src="${context}/img/home.png" alt="회원관리 홈 으로" width="30" height="30">
		</a>
		<a href="${context}/index.jsp">
			<img src="${context}/img/Previous.png" alt="메인 홈 으로" width="30" height="30">
		</a>
	</div>
</body>
</html>